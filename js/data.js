 ...
 * data.js
 * ------------------------------------------------------------------
 * Single source of truth for content shown on the site.
 *
 * HOW TO CONNECT A REAL BACKEND LATER:
 * Every function below already returns a Promise, so the rest of the
 * app doesn't know or care whether the data comes from a local array
...
const PahuwaySpaceData = (() => {
  ...
  const propertiesNearYou = [
    {
      ...
      image: IMG + "PROPERTIES_NEAR_YOU_PIC_1.png",
      verified: true,
      status: "available",
    ...
    },
    {
      ...
      image: IMG + "PROPERTIES_NEAR_YOU_PIC_2.png",
      verified: true,
      status: "available",
    ...
    },
    {
      ...
      image: IMG + "PROPERTIES_NEAR_YOU_PIC_3.png",
      verified: true,
      status: "available",
  ...
  const featuredNewProperties = [
    {
      ...
      priceUnit: "monthly",
      specs: { beds: 2, baths: 2, area: "50 sqm" },
      image: IMG + "NEW_PROPERTIES_1.png",
      verified: true,
      status: "available",
    ...
    },
    {
      ...
      image: IMG + "NEW_PROPERTIES_2.png",
      verified: true,
      status: "available",
    ...
    },
    {
      ...
      image: IMG + "NEW_PROPERTIES_3.png",
      verified: true,
      status: "available",
  ...
  const recentlyRentedProperties = [
    {
      ...
      image: IMG + "RENTED_PROPERTIES_1.png",
      verified: false,
      status: "rented",
    ...
    },
    {
      ...
      image: IMG + "RENTED_PROPERTIES_2.png",
      verified: true,
      status: "rented",
    ...
    },
    {
      ...
      image: IMG + "RENTED_PROPERTIES_3.png",
      verified: true,
      status: "rented",
  ...
  const destinations = [
    { id: "manila", name: "Manila", listingCount: 214, gradient: "linear-gradient(160deg,#3a3226,#151210)" },
    { id: "quezon-city", name: "Quezon City", listingCount: 178, gradient: "linear-gradient(160deg,#3a1f2e,#160c14)" },
    { id: "makati", name: "Makati", listingCount: 261, gradient: "linear-gradient(160deg,#1f2b3a,#0c1218)" },
    { id: "cebu-city", name: "Cebu City", listingCount: 132, gradient: "linear-gradient(160deg,#123a3a,#0a1616)" },
    { id: "iloilo-city", name: "Iloilo City", listingCount: 64, gradient: "linear-gradient(160deg,#3a2f12,#161006)" },
  ];
